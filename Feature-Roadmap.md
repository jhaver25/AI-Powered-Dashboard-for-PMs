# AI-Powered Dashboard for PMs - Feature Roadmap
...
3. Add RAG status-change flags in markdown exports (currently only available in webpage view)
...
## Other Ideas
- JIRA API integration - retrieving specific ticket #'s and descriptions
- JIRA API integration - retrieving team-level velocity data to show productivity trends over time
- Export to PPT / PDF for sharing with executives or using as an input into related presentations
